  ...
  return (
    <DashboardShell title="Dashboard global" subtitle="Vue synthétique du suivi des ressources en eau et de l’inventaire des points d’eau">
      ...
      <div className="grid-3" style={{ marginTop: 18 }}>
        ...
        <div className="panel"><h2>Accès rapides</h2><div className="quick-list"><Link href="/points-eau">🚰 Dashboard Points d’eau</Link><Link href="/cartographie">🗺️ Cartographie thématique</Link><Link href="/pluviometrie">🌧️ Pluviométrie</Link><Link href="/piezometrie">💧 Piézométrie</Link><Link href="/limnimetrie">🌊 Limnimétrie</Link></div></div>
      </div>
