...
select 'pluviometrie' as module, code_station as code, nom_station as libelle, latitude, longitude, synced_at, null::text as statut_fonctionnalite, null::text as type_infrastructure, null::text as commune, null::text as village, null::text as priorite_rehabilitation, null::text as equipement, null::text as organe_gestion, null::numeric as ph, null::numeric as conductivite, null::numeric as tds, false as alerte_qualite_eau, false as alerte_gps, '#0077B6'::text as couleur from stations_pluvio where latitude is not null and longitude is not null
union all select 'piezometrie', code_piezo, code_piezo, latitude, longitude, synced_at, null, null, null, null, null, null, null, null, null, null, false, false, '#5B2A86' from piezometres where latitude is not null and longitude is not null
union all select 'limnimetrie', code_station, cours_eau, latitude, longitude, synced_at, null, null, null, null, null, null, null, null, null, null, false, false, '#48CAE4' from stations_limni where latitude is not null and longitude is not null
union all select 'points_eau', code_pe, coalesce(localite, village, type_infrastructure), latitude, longitude, synced_at, statut_fonctionnalite, type_infrastructure, commune, village, priorite_rehabilitation, equipement, organe_gestion, ph, conductivite, tds, alerte_qualite_eau, alerte_gps, couleur_statut from v_points_eau_dashboard where latitude is not null and longitude is not null;
